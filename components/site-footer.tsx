...
export function SiteFooter() {
  ...
  const isHybrid = usePathname().startsWith("/draft-hybrid");
  const base = isDraftTwo ? "/draft-2" : isHybrid ? "/draft-hybrid" : "";
  return (
