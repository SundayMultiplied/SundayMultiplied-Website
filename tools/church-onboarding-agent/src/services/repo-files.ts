import type { BrandProfile, OnboardingState } from "../types";
...
.sm-header, .sm-header.sm-header--with-logo {
  margin-bottom: 38px;
  padding: ${b.headerStyle === "filled" ? "24px" : "0 0 24px"};
...
@media print {
  ...
  .sm-header, .sm-header.sm-header--with-logo { margin-bottom: 10px; padding: 0 0 8px; background: #fff; color: #111; border-radius: 0; border-bottom-color: #000; }
