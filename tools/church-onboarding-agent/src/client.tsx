...
function OnboardingApp() {
  ...
  return <main className={step === 2 ? "shell shell--theme" : "shell"}>
    ...
    <section className={step === 2 ? "card card--theme" : "card"}>
      ...
      {step === 3 && <Approval state={state} setState={setState} busy={busy} save={() => run(() => agent.stub.saveApproval(state.reviewers, state.resources, state.deliveryDay, state.familyWorship || { style: "blended", platform: "youtube" }), 4)} />}
