...
function buildPreviewDocument(churchName: string, b: ResolvedBrandProfile, logoUrl?: string) {
  ...
  const headerBg = b.headerStyle === "plain" ? b.backgroundColor : b.headerBackgroundColor;
...
header{display:flex;align-items:center;justify-content:space-between;gap:28px;margin-bottom:38px;padding:${b.headerStyle === "plain" ? "0 0 24px" : "24px"};background:${headerBg};color:${headerText};border-bottom:4px solid ${b.primaryColor};border-radius:${b.headerStyle === "filled" ? b.cornerRadius : "0"}}header .text{flex:1;order:${b.logoPosition === "left" ? "2" : "1"}}header .brand{order:${b.logoPosition === "left" ? "1" : "2"}}.logo{max-width:180px;max-height:68px;object-fit:contain}.logo-placeholder{padding:18px;border:1px dashed ${b.borderColor};color:${headerText};font-size:12px;letter-spacing:.18em}
.eyebrow{margin:0 0 8px;color:${b.headerStyle === "plain" ? b.accentColor : b.headerTextColor};font-size:12px;font-weight:800;letter-spacing:.15em;text-transform:uppercase}.title{margin:0;font-family:${b.headingFont};font-size:34px;line-height:1.1;font-weight:${b.headingWeight};text-transform:${b.headingTransform}}.meta{margin:10px 0 0;color:${b.headerStyle === "plain" ? b.mutedColor : b.headerTextColor};opacity:.82;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:.06em}
section{margin-bottom:${b.sectionSpacing}}h2,h3{font-family:${b.headingFont};font-weight:${b.headingWeight};text-transform:${b.headingTransform};color:${b.primaryColor}}h2{margin:0 0 12px;font-size:20px}h3{color:${b.accentColor};font-size:15px}p{line-height:1.65;margin:0 0 13px}.big{padding:22px 24px;border-left:6px solid ${b.accentColor};border-radius:${b.cornerRadius};background:${b.calloutBackgroundColor}}.scripture{padding:24px;border:1px solid ${b.borderColor};border-radius:${b.cornerRadius}}.scripture .text{padding:18px 20px;border-left:4px solid ${b.accentColor};background:${b.scriptureBackgroundColor}}.snapshot,.questions,.practice,.tip{padding:20px 22px;border:${border};border-radius:${b.cornerRadius};background:${cardBg}}.questions{background:${b.questionBackgroundColor}}ol{padding-left:22px}li{margin-bottom:10px;line-height:1.55}li::marker{color:${b.accentColor};font-weight:800}.prayer{padding:22px 24px;border-radius:${b.cornerRadius};background:${b.prayerBackgroundColor};color:${b.prayerTextColor}}.prayer h2{color:${b.prayerTextColor}}.button{display:inline-block;padding:11px 18px;border-radius:${buttonRadius};background:${b.primaryColor};color:white;font-weight:800;text-decoration:none}.muted{color:${b.mutedColor}}
